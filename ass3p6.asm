...
.stack 100h
.data
file db '/Users/varundas/Documents/myfile.asm',00      ; File Path (Note: Folders are not created, so always create a file inside existing folderor drive). 0 is used to append the file
